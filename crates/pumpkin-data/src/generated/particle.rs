...
impl Particle {
    ...
    pub const fn from_id(id: u16) -> Option<Self> {
        match id {
            0u16 => Some(Self::AngryVillager),
            1u16 => Some(Self::Block),
            2u16 => Some(Self::BlockMarker),
            3u16 => Some(Self::Bubble),
            4u16 => Some(Self::SulfurBubbles),
            5u16 => Some(Self::NoxiousGas),
            6u16 => Some(Self::NoxiousGasCloud),
            7u16 => Some(Self::Geyser),
            8u16 => Some(Self::GeyserBase),
            9u16 => Some(Self::GeyserPoof),
            10u16 => Some(Self::GeyserPlume),
            11u16 => Some(Self::Cloud),
            12u16 => Some(Self::CopperFireFlame),
            13u16 => Some(Self::Crit),
            14u16 => Some(Self::DamageIndicator),
            15u16 => Some(Self::DragonBreath),
            16u16 => Some(Self::DrippingLava),
            17u16 => Some(Self::FallingLava),
            18u16 => Some(Self::LandingLava),
            19u16 => Some(Self::DrippingWater),
            20u16 => Some(Self::FallingWater),
            21u16 => Some(Self::Dust),
            22u16 => Some(Self::DustColorTransition),
            23u16 => Some(Self::Effect),
            24u16 => Some(Self::ElderGuardian),
            25u16 => Some(Self::EnchantedHit),
            26u16 => Some(Self::Enchant),
            27u16 => Some(Self::EndRod),
            28u16 => Some(Self::EntityEffect),
            29u16 => Some(Self::ExplosionEmitter),
            30u16 => Some(Self::Explosion),
            31u16 => Some(Self::Gust),
            32u16 => Some(Self::SmallGust),
            33u16 => Some(Self::GustEmitterLarge),
            34u16 => Some(Self::GustEmitterSmall),
            35u16 => Some(Self::SonicBoom),
            36u16 => Some(Self::FallingDust),
            37u16 => Some(Self::Firework),
            38u16 => Some(Self::Fishing),
            39u16 => Some(Self::Flame),
            40u16 => Some(Self::Infested),
            41u16 => Some(Self::CherryLeaves),
            42u16 => Some(Self::PaleOakLeaves),
            43u16 => Some(Self::TintedLeaves),
            44u16 => Some(Self::SculkSoul),
            45u16 => Some(Self::SculkCharge),
            46u16 => Some(Self::SculkChargePop),
            47u16 => Some(Self::SoulFireFlame),
            48u16 => Some(Self::Soul),
            49u16 => Some(Self::Flash),
            50u16 => Some(Self::HappyVillager),
            51u16 => Some(Self::Composter),
            52u16 => Some(Self::Heart),
            53u16 => Some(Self::InstantEffect),
            54u16 => Some(Self::Item),
            55u16 => Some(Self::Vibration),
            56u16 => Some(Self::Trail),
            57u16 => Some(Self::PauseMobGrowth),
            58u16 => Some(Self::ResetMobGrowth),
            59u16 => Some(Self::ItemSlime),
            60u16 => Some(Self::ItemCobweb),
            61u16 => Some(Self::ItemSnowball),
            62u16 => Some(Self::LargeSmoke),
            63u16 => Some(Self::Lava),
            64u16 => Some(Self::Mycelium),
            65u16 => Some(Self::Note),
            66u16 => Some(Self::Poof),
            67u16 => Some(Self::Portal),
            68u16 => Some(Self::Rain),
            69u16 => Some(Self::Smoke),
            70u16 => Some(Self::WhiteSmoke),
            71u16 => Some(Self::Sneeze),
            72u16 => Some(Self::Spit),
            73u16 => Some(Self::SquidInk),
            74u16 => Some(Self::SweepAttack),
            75u16 => Some(Self::TotemOfUndying),
            76u16 => Some(Self::Underwater),
            77u16 => Some(Self::Splash),
            78u16 => Some(Self::Witch),
            79u16 => Some(Self::BubblePop),
            80u16 => Some(Self::CurrentDown),
            81u16 => Some(Self::BubbleColumnUp),
            82u16 => Some(Self::Nautilus),
            83u16 => Some(Self::Dolphin),
            84u16 => Some(Self::CampfireCosySmoke),
            85u16 => Some(Self::CampfireSignalSmoke),
            86u16 => Some(Self::DrippingHoney),
            87u16 => Some(Self::FallingHoney),
            88u16 => Some(Self::LandingHoney),
            89u16 => Some(Self::FallingNectar),
            90u16 => Some(Self::FallingSporeBlossom),
            91u16 => Some(Self::Ash),
            92u16 => Some(Self::CrimsonSpore),
            93u16 => Some(Self::WarpedSpore),
            94u16 => Some(Self::SporeBlossomAir),
            95u16 => Some(Self::DrippingObsidianTear),
            96u16 => Some(Self::FallingObsidianTear),
            97u16 => Some(Self::LandingObsidianTear),
            98u16 => Some(Self::ReversePortal),
            99u16 => Some(Self::WhiteAsh),
            100u16 => Some(Self::SmallFlame),
            101u16 => Some(Self::Snowflake),
            102u16 => Some(Self::DrippingDripstoneLava),
            103u16 => Some(Self::FallingDripstoneLava),
            104u16 => Some(Self::DrippingDripstoneWater),
            105u16 => Some(Self::FallingDripstoneWater),
            106u16 => Some(Self::GlowSquidInk),
            107u16 => Some(Self::Glow),
            108u16 => Some(Self::WaxOn),
            109u16 => Some(Self::WaxOff),
            110u16 => Some(Self::ElectricSpark),
            111u16 => Some(Self::Scrape),
            112u16 => Some(Self::Shriek),
            113u16 => Some(Self::EggCrack),
            114u16 => Some(Self::DustPlume),
            115u16 => Some(Self::TrialSpawnerDetection),
            116u16 => Some(Self::TrialSpawnerDetectionOminous),
            117u16 => Some(Self::VaultConnection),
            118u16 => Some(Self::DustPillar),
            119u16 => Some(Self::OminousSpawning),
            120u16 => Some(Self::RaidOmen),
            121u16 => Some(Self::TrialOmen),
            122u16 => Some(Self::BlockCrumble),
            123u16 => Some(Self::Firefly),
            124u16 => Some(Self::SulfurCubeGoo),
            _ => None,
        }
    }
    #[must_use]
