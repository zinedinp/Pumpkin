...
impl CowVariant {
    ...
    pub const fn asset_id(&self) -> &'static str {
        match self {
            Self::Cold => "minecraft:entity/cow/cow_cold",
            Self::Temperate => "minecraft:entity/cow/cow_temperate",
            Self::Warm => "minecraft:entity/cow/cow_warm",
        }
    }
    #[must_use]
    pub const fn baby_asset_id(&self) -> Option<&'static str> {
        match self {
            Self::Cold => Some("minecraft:entity/cow/cow_cold_baby"),
            Self::Temperate => Some("minecraft:entity/cow/cow_temperate_baby"),
            Self::Warm => Some("minecraft:entity/cow/cow_warm_baby"),
        }
    }
    #[must_use]
