...
impl PigVariant {
    ...
    pub const fn asset_id(&self) -> &'static str {
        match self {
            Self::Cold => "minecraft:entity/pig/pig_cold",
            Self::Temperate => "minecraft:entity/pig/pig_temperate",
            Self::Warm => "minecraft:entity/pig/pig_warm",
        }
    }
    #[must_use]
    pub const fn baby_asset_id(&self) -> Option<&'static str> {
        match self {
            Self::Cold => Some("minecraft:entity/pig/pig_cold_baby"),
            Self::Temperate => Some("minecraft:entity/pig/pig_temperate_baby"),
            Self::Warm => Some("minecraft:entity/pig/pig_warm_baby"),
        }
    }
    #[must_use]
