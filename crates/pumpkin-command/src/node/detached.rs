...
impl<S: CommandSource> LiteralDetachedNode<S> {
    ...
    ///
    /// # Note
    /// Prefer using the [`literal`](crate::argument_builder::literal) function over this one.
    pub fn new(
...
impl<S: CommandSource> CommandDetachedNode<S> {
    ...
    ///
    /// # Note
    /// Prefer using the [`command`](crate::argument_builder::command) function over this one.
...
impl<S: CommandSource> ArgumentDetachedNode<S> {
    ...
    ///
    /// # Note
    /// Prefer using the [`argument`](crate::argument_builder::argument) function over this one.
    #[expect(clippy::too_many_arguments)]
    pub fn new(
        global_id: GlobalNodeId,
